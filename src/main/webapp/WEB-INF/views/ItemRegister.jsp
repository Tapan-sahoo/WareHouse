	...
	<div class="container">
		<div class="card">
			<div class="card-header bg-success text-white text-center">
				<h2>Welcome to Item Registration Page</h2>
			</div>
			<div class="card-body">
				...
				<form:form action="insert" method="POST" modelAttribute="item"
					...
					<div class="form-group">
						<label for="Length" class="control-label col-sm-4">Item
							Dimensions</label> 
						<form:input path="width" size="10px" /> W
						<form:input path="length" size="10px" /> L
						<form:input path="height" size="10px" /> H
					...
					<div class="form-group">
						<label for="whVendor" class="control-label col-sm-4">Item
							Vendors</label>
					...
					<div class="form-group">
						<label for="whCustomer" class="control-label col-sm-4">Item
							Customers</label>
					...
					<div class="form-group">
						<label for="dcpt" class="control-label col-sm-4">Item NOTE</label>
