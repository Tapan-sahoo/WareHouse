...
//ctrl+shift+O (imports)
	...
	public class AppConfig  implements WebMvcConfigurer{
		...
		public LocalSessionFactoryBean sfObj() {
			...
			sf.setAnnotatedClasses(Uom.class, OrderMethod.class,ShipmentType.class,WhUserType.class,Document.class,Vendor.class,Customer.class,Item.class,PurchaseOrder.class);
